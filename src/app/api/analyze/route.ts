...
반드시 아래 JSON 형식으로만 응답하세요:
{
  ...
  "tokens": [
    { "word": "영단어 또는 영어 숙어", "pos": "품사 (반드시 한국어로)", "meaning": "한국어 뜻" } 
  ]
}

🚨 중요 규칙: 
1. tokens 배열은 반드시 네가 번역/교정한 최종 영문장(corrected)에 포함된 '영단어'들을 기준으로 분해해서 작성하세요. 절대 사용자가 입력한 한글 원본을 쪼개서 넣으면 안 됩니다.
2. tokens 배열 안의 'pos' 값은 절대로 영어를 쓰지 마세요. 반드시 '명사', '동사', '형용사', '부사', '전치사', '접속사', '대명사' 등 명확한 한국어 품사 명칭으로만 출력해야 합니다.`,
        },
        {
          role: "user",
          content: text,
